...
const router = createBrowserRouter(
  createRoutesFromElements([
    ...
    <Route path="/files/details/:id" element={<ProtectedRoute> <FilesDetails api={apiLink}/> </ProtectedRoute>} />,
    ...
    <Route path="/invoices/details/:id" element={<ProtectedRoute> <InvoicesDetails api={apiLink}/> </ProtectedRoute>} />,
